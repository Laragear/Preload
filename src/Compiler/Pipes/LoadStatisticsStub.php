...
class LoadStatisticsStub
{
    ...
    {
        $listing->statistics = $listing->statistics->append($this->stubContents());
    ...
    {
        try {
            return $this->files->get(Preloader::STUB_STATISTICS);
        } catch (FileNotFoundException $e) {
            throw new PreloadException(
                'Cannot read the stub "'.Preloader::STUB_STATISTICS.'" contents.', $e->getCode(), $e
            );
        }
    }
}
